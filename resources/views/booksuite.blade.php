...
<div class="detail-container">
 ...
 <form action="/checkout/suite" method="POST">
    @csrf
    ...
    <input type="hidden" name="room" value="Suite Room">
    ...
    <button type="submit" class="home-btn" style="width: 100%; margin-top: 20px;">Confirm & Pay</button>
        ...
        <div class="price-box">
            ...
            <img src="{{ asset('images/suiteroom.jpeg') }}" alt="Suite Room" style="width: 100%; height: 300px; object-fit: cover; border-radius: 8px; margin-bottom: 15px;">

            <h3 class="detail-subtitle" style="margin-bottom: 5px; margin-top: 0;">Suite Room</h3>
            <p class="detail-meta" style="margin-bottom: 20px;">50 m² · 4 guests</p>
